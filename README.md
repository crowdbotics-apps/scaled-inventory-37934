...
## Project Structure
    ...
    ├── scaled_inventory_37934  # Django project configurations
...
1. Clone this repo and `cd scaled_inventory_37934`
...
2. Clone this repo and `cd scaled_inventory_37934`
